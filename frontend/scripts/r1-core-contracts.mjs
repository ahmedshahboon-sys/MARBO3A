...
const imports=[...layout.matchAll(/import\s+["']\.\/(.+?\.css)["'];/g)].map(x=>x[1]);if(imports.at(-1)!=="ui-v3-unified-scale.css")throw new Error("Unified scale must remain final CSS layer");
