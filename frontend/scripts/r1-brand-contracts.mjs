...
try{const svg=await fs.readFile("public/brand/official/marbo3a-mark.svg","utf8");if(svg.length<10000||!svg.includes("<svg")||!svg.includes("data:image/webp;base64,"))throw new Error("invalid canonical SVG")}catch(e){console.error(`Invalid canonical brand SVG: ${e.message}`);failed=true}
