...
for(const selector of [".social-dock-track",".messages-v3-page",".notifications-shell",".room-community-compose"])if(!finalCss.includes(selector))fail(`final V3 contract is missing ${selector}`);
