...
export const metadata = {
  ...
  openGraph:{title:"مربوعة",description:"مكانك للتواصل، الغرف، والأصحاب",url:"https://marbo3a.ly",siteName:"مربوعة",locale:"ar_LY",type:"website"}
};
...
export default function RootLayout({children}){
  return <html lang="ar" dir="rtl" className={cairo.variable}><body className={cairo.className}><AppBootstrap/><PlatformClient/>{children}<AdminConsole/></body></html>;
}
