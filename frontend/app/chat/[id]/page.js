...
export default function DirectChat(){
  ...
  const box=useRef(null),typingTimer=useRef(null),lastReadSent=useRef(0),mounted=useRef(true);
  ...
  useEffect(()=>{mounted.current=true;if(!id)return;loadShell();return()=>{mounted.current=false}},[id]);
