...
import {AdminStepUpPanel,AdminStepUpProvider} from "./AdminStepUpContext";

export default function UnifiedAdmin(){
 const[section,setSection]=useState("center");
 return <AdminStepUpProvider><main className="unified-admin" dir="rtl">
