...
export default function SocialDock(){
 ...
 return <nav className="social-dock" aria-label="التنقل الرئيسي"><div className="social-dock-track">
  <Link prefetch href="/home" className={active("/home")?"active":""}><Icon name="home"/><span>الرئيسية</span></Link>
  <Link prefetch href="/friends" className={active("/friends")?"active":""}><Icon name="users"/><span>الأصحاب</span></Link>
  <Link prefetch href="/feed#compose" className={`dock-create ${active("/feed")?"active":""}`} aria-label="إنشاء منشور"><Icon name="sparkles"/><span>نشر</span></Link>
