...
export default function MediaGallery({items=[],alt="وسائط",className=""}){
 ...
 const[index,setIndex]=useState(null),swipe=useRef(null);
 ...
 return <>
  ...
  {current&&<div className="media-viewer" role="dialog" aria-modal="true" aria-label="عارض الوسائط" onMouseDown={e=>e.target===e.currentTarget&&setIndex(null)} onPointerDown={pointerDown} onPointerUp={pointerUp} onPointerCancel={()=>{swipe.current=null}}>
