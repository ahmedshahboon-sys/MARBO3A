...
export default function SideDrawer(){
  ...
  const items=[["/home","home","الرئيسية"],["/search","search","البحث"],["/notifications","bell","الإشعارات"],["/friends","users","الأصحاب"],["/messages","message","الرسائل"],["/rooms","hash","الغرف"],["/marketplace","bookmark","المتاجر · قريبًا"],["/engagement","sparkles","التفاعل والشائع"],["/map","map","الخريطة"],[`/u/${me.username}`,"user","ملفي الشخصي"],["/saved","bookmark","المحفوظات"],["/profile/edit","image","تعديل الملف"],["/blocked","warning","المحظورون"]];
