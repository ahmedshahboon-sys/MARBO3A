export default function Icon({name,size=20,strokeWidth=1.9,className=""}){
  const paths={
    ...
    micOff:<><path d="m3 3 18 18"/><path d="M9 5v5a3 3 0 0 0 4.6 2.5"/><path d="M15 9V5a3 3 0 0 0-5.1-2.1"/><path d="M5 10a7 7 0 0 0 11.7 5.2"/><path d="M19 10a7 7 0 0 1-.7 3.1"/><path d="M12 17v5M8 22h8"/></>,
